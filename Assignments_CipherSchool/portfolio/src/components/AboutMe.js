            ...
            <div className="card mt-5 mb-5" style={{ 'height': '100%' }}>
                <div className="row">
                    ...
                    <div className="title-box-2 pt-4 pt-md-0 mt-4">
                            <h2 class="title-left animate__animated animate__bounce" style={{fontWeight:'200%'}}>About Me</h2>
                            <hr className="" style={{width:170 , background : 'blue' , height : 5}} />
                        </div>
                        <div className="card-body lead">
                            <p>Software Engineer who loves to transform ideas into reality using code. I am passionate about using Javascript and Animation Libraries to create awesome user experiences.</p>    <br/>
                            <p>With over two years of experience developing web applications using the latest front-end and back-end technologies.</p> <br/>
                            <p>Motivated designer and developer with experience creating custom websites with ReactJs, JavaScript, HTML5, and CSS3. Strong collaboration skills and proven history of application development. Wordpress and MySQL.</p>
                        </div>
                    </div>
                </div>
            </div>
